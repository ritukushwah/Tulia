...
<body>
    ...
    <div class="container">
    <h1 class="welcome text-center"><img style="display:inline-block" width="150" src="<?php echo base_url() ?>backend_asset/custom/images/tulia_logo_150x150.png" class="img-responsive" alt="" /></h1>
